...
# Google and Mapbox API keys
API_KEY = 'AIzaSyDBW-s9-SubwQF9XYVoer6oVKLrkSlMKdc'  # Replace with your Google API key
MAPBOX_ACCESS_TOKEN = 'pk.eyJ1IjoiZ29rdWxha3Jpc2huYW4tNjEwIiwiYSI6ImNtMjdkNWxpaDFiZWoyaXM2czRhZTY0cGoifQ.hv7LUuaUken_pJ88fsvYKA'  # Replace with your Mapbox access token
...
def chatbot():
    ...
    try:
        gemini_api_url = "https://gemini.googleapis.com/v1/chat"  # Hypothetical API URL (replace with actual)
        headers = {
            'Authorization': f'Bearer {API_KEY}',  # Your API Key
            'Content-Type': 'application/json'
        }
        payload = {
            "message": user_message,
            "context": "chat"  # Adjust based on the Gemini API context
        }
...
API_KEY = 'AIzaSyDBW-s9-SubwQF9XYVoer6oVKLrkSlMKdc'  
MAPBOX_ACCESS_TOKEN = 'pk.eyJ1IjoiZ29rdWxha3Jpc2huYW4tNjEwIiwiYSI6ImNtMjdkNWxpaDFiZWoyaXM2czRhZTY0cGoifQ.hv7LUuaUken_pJ88fsvYKA'  # Replace with your Mapbox access token
